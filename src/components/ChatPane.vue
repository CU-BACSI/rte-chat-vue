...
const props = defineProps<{ placeholder: string, title: string, messages: { content: string, role: string }[], handleSubmit: (payload: Event) => void, setMessages: (m: any[]) => void }>()
const clearMessages = () => props.setMessages([]);
